...
class HomeFragment : Fragment(),  (Service) -> Unit  {
    ...
    private var selectService: Service? = null
    ...
    override fun onCreateView(
        ...
        services.add(Service("ofertado", "Carpinteria"))
        services.add(Service("contratado", "Fontaneria"))
    ...
    override fun invoke(s: Service) {
        ...
        selectService = s;
        bundle = Bundle()
        bundle.putSerializable("service", selectService)
